...
def parse_common_args(parser):
    ...
    # Dataset setting
    parser.add_argument('--data_type', type=str, default='Base', choices=['Base', 'Base_ND', 'RTF'], help='"RTF" for Run-To-Failure dataset, "ND" only works in training (see "-N" for more details)')
